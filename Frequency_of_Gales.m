...
gale_force_wind = prctile(wind_data_QC(:,3), 50)
...
bar(plot_years, actual_gale_hours, 'w', 'linewidth', 2);
ylim([0 100])
xlim([1948 2017])
title('Aldergrove - Annual Hours of January Wind Speeds >99.5th Percentile', 'fontsize', 15)
xlabel('Year', 'fontsize', 14, 'fontweight', 'bold')
ylabel('Hours per January of Wind Speed > 99.5th Percentile', 'fontsize', 14, 'fontweight', 'bold')
set(gca, 'fontsize', 12)
set(gca, 'ytick', 0:10:1500)
...
yyaxis right;
ylabel('January NAO Index')
ylim([-15 5]);
plot(plot_years(1:67), jan_nao(:,2), 'k', 'linewidth', 3);

% [rall,pall] = corrcoef(actual_gale_hours(1:67), jan_nao(:,2))
% [rpre85, ppre85] = corrcoef(actual_gale_hours(1:37), jan_nao(1:37,2))
% [rpost85, ppost85] = corrcoef(actual_gale_hours(38:67), jan_nao(38:67,2))
