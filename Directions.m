...
[rall,pall] = corrcoef(actual_gale_hours(1,1:58), jan_nao(10:67,2));
[rpre85, ppre85] = corrcoef(actual_gale_hours(1,1:28), jan_nao(10:37,2));
[rpost85, ppost85] = corrcoef(actual_gale_hours(1,29:58), jan_nao(38:67,2), 'rows', 'pairwise');

% add correlations to coeffs
% rall pall rpre85 ppre85 rpost85 ppost85
% lerwick first 
% FOR 01/12/57 to 01/02/58 and onwards
