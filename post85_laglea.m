...
for k = 1:years;
    decembers(k) = datenum([1984+k 12 01 00 00 00]);
    januarys(k) = datenum([1985+k 01 01 00 00 00]);
...
for k = 1:20;
    [oct_r_cell{k}, oct_p_cell{k}] = corrcoef(hourscell{k}(1:31), oct_nao(37:67,2));
end
...
for k = 1:20;
    [nov_r_cell{k}, nov_p_cell{k}] = corrcoef(hourscell{k}(1:31), nov_nao(37:67,2));
end
...
for k = 1:20;
    [dec_r_cell{k}, dec_p_cell{k}] = corrcoef(hourscell{k}(1:31), dec_nao(37:67,2));
end
...
for k = 1:20;
    [jan_r_cell{k}, jan_p_cell{k}] = corrcoef(hourscell{k}(1:30), jan_nao(38:67,2));
end
...
for k = 1:20;
    [feb_r_cell{k}, feb_p_cell{k}] = corrcoef(hourscell{k}(1:30), feb_nao(38:67,2));
end
